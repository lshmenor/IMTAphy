...
#ifndef IMTAPHY_RECEIVERS_CHANNELESTIMATION_THERMALNOISEBASED_HPP
#define IMTAPHY_RECEIVERS_CHANNELESTIMATION_THERMALNOISEBASED_HPP
...
namespace imtaphy {
    ...
    namespace receivers {
        ...
        {
        public:
            ThermalNoiseBasedGaussianError(LinearReceiver* receiver);
            
            ThermalNoiseBasedGaussianError(LinearReceiver* receiver, const wns::pyconfig::View& pyConfigView);
