...
#ifndef IMTAPHY_RECEIVERS_GAUSSIANNOISEANDINTERFERENCECOVARIANCE_HPP
#define IMTAPHY_RECEIVERS_GAUSSIANNOISEANDINTERFERENCECOVARIANCE_HPP
...
namespace imtaphy {
    ...
    namespace receivers {
        ...
        class GaussianErrorInterferenceAndNoiseCovariance :
             public NoiseAndInterferenceCovarianceInterface
        {
        public:
            GaussianErrorInterferenceAndNoiseCovariance(LinearReceiver* receiver);
            
            GaussianErrorInterferenceAndNoiseCovariance(LinearReceiver* receiver, const wns::pyconfig::View& pyConfigView);
            ...
            void addGaussianError(imtaphy::detail::ComplexFloatMatrixPtr matrix, wns::Ratio relativeErrorPower);
            
        protected:
            unsigned int numRxAntennas;
            imtaphy::Direction direction;
            imtaphy::receivers::LinearReceiver* receiver;
            wns::Ratio relativeErrorPower;
        };
