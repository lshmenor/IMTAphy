...
namespace imtaphy {
    ...
    namespace receivers {
        ...
        namespace filters {
            ...
            {
            public:
                MMSE(const wns::pyconfig::View& pyConfigView);
            ...
            private:
                ...
                imtaphy::receivers::channelEstimation::covariance::NoiseAndInterferenceCovarianceInterface* noiseAndIcovariance;
                int maxRank;
            };
    }}}
