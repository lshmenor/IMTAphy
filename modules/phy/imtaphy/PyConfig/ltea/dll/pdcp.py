...
class eNB(openwns.FUN.FunctionalUnit, openwns.StaticFactoryClass):
    ...
    def __init__(self, parentLogger = None):
        openwns.StaticFactoryClass.__init__(self, 'ltea.pdcp.eNB')
        openwns.FUN.FunctionalUnit.__init__(self, functionalUnitName = "pdcp")
...
class UE(openwns.FUN.FunctionalUnit, openwns.StaticFactoryClass):
    ...
    def __init__(self, parentLogger = None):
        openwns.StaticFactoryClass.__init__(self, 'ltea.pdcp.UE')
        openwns.FUN.FunctionalUnit.__init__(self, functionalUnitName = "pdcp")
