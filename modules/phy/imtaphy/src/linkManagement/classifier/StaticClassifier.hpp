...
#ifndef IMTAPHY_LINKCLASSIFIER_STATIC
#define IMTAPHY_LINKCLASSIFIER_STATIC
...
namespace imtaphy { namespace linkclassify {
        ...
        {
        public:
            StaticClassifier(imtaphy::Channel* channel, wns::pyconfig::View config);
