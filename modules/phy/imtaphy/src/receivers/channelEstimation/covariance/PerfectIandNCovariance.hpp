...
#ifndef IMTAPHY_RECEIVERS_PERFECTNOISEANDINTERFERENCECOVARIANCE_HPP
#define IMTAPHY_RECEIVERS_PERFECTNOISEANDINTERFERENCECOVARIANCE_HPP
...
namespace imtaphy {
    ...
    namespace receivers {
        ...
        class PerfectInterferenceAndNoiseCovariance :
             public NoiseAndInterferenceCovarianceInterface
        {
        public:
            PerfectInterferenceAndNoiseCovariance(LinearReceiver* receiver);
            
            PerfectInterferenceAndNoiseCovariance(LinearReceiver* receiver, const wns::pyconfig::View& pyConfigView);
