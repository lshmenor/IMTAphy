...
namespace imtaphy {
    ...
    namespace receivers {
        ...
        class DiagonalIandNCovariance :
             public NoiseAndInterferenceCovarianceInterface
        {
        public:
            DiagonalIandNCovariance(LinearReceiver* receiver);
            
            DiagonalIandNCovariance(LinearReceiver* receiver, const wns::pyconfig::View& pyConfigView);
