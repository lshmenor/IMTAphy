...
#ifndef IMTAPHY_RECEIVERS_WISHARTESTIMATIONMODEL36829_HPP
#define IMTAPHY_RECEIVERS_WISHARTESTIMATIONMODEL36829_HPP
...
namespace imtaphy {
    ...
    namespace receivers {
        ...
        class WishartEstimationModel36_829 :
             public NoiseAndInterferenceCovarianceInterface
        {
        public:
            WishartEstimationModel36_829(LinearReceiver* receiver);
            
            WishartEstimationModel36_829(LinearReceiver* receiver, const wns::pyconfig::View& pyConfigView);
